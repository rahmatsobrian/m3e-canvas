...
export function Toolbar({
  ...
  onLangSheet?: () => void;
  /** phone: open one of the full editor panels in a touch-sized sheet */
  onMobilePanel?: (panel: "parts" | "layers") => void;
  /** phone: project, language and the remaining editor tools */
  onMobileMore?: () => void;
      ...
      <>
        <div className="m3-mobile-topbar">
          <Pill p={p}>
            ...
            <IconBtn icon="fit_screen" p={p} onClick={onFit} title={t("fit", lang)} size={S} />
