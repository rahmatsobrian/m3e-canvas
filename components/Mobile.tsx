...
export function BottomSheet({ p, onClose, children, full = false }: { p: Palette; onClose: () => void; children: React.ReactNode; full?: boolean }) {
  const lang = useLang();
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        right: 0,
        bottom: 0,
        height: full ? "min(88%, 780px)" : undefined,
        maxHeight: full ? "88%" : "72%",
        display: "flex",
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          padding: full ? "0 0 8px" : "0 14px 16px",
          minHeight: 0,
